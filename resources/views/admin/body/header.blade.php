<header id="page-topbar">
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            @php
            $id = Auth::user()->id;
            $adminData = App\Models\User::query()->find($id);
            @endphp
