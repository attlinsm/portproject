                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('skills.update', $skill->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ (!empty(asset('upload/skills_images/' . $skill->image))) ? asset('upload/skills_images/' . $skill->image) : url('upload/no_image.jpg') }}" alt="Card image cap">
                                    </div>
                                </div>
