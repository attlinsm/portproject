                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('skills.update', $skill->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ (!empty(asset('storage/upload/skills_images/' . $skill->image))) ? asset('storage/upload/skills_images/' . $skill->image) : url('upload/no_image.jpg') }}" alt="Card image cap">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                                    <div class="col-sm-10">
                                        <img id="showIcon" class="rounded avatar-lg" src="{{ (!empty(asset('storage/upload/skills_images/icons/' . $skill->icon))) ? asset('storage/upload/skills_images/icons/' . $skill->icon) : url('upload/no_image.jpg') }}" alt="Card image cap">
                                    </div>
                                </div>
