                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('skills.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('short_description') is-invalid @enderror" type="text"  id="short_description" name="short_description">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('pros_list') is-invalid @enderror" type="text"  id="pros_list" name="pros_list">
                                        @error('pros_list')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ url('storage/upload/no_image.jpg') }}" alt="Card image cap">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                                    <div class="col-sm-10">
                                        <img id="showIcon" class="rounded avatar-lg" src="{{ url('storage/upload/no_image.jpg') }}" alt="Card image cap">
                                    </div>
                                </div>
